...
class QuestionController extends GetxController
  ...
  List<Question> _questions = sample_data
      .map(
        (question) => Question(
            ...
            music: question['music']!=null?question['music']:"",
            options: question['answers']!=null?question['answers']:[],
  ...
  void nextQuestion() {
    if (_questionNumber.value != _questions.length) {
      ...
      viewModel.quizResultAPI(context: Get.context!, score: '${_numOfCorrectAns * 10}');
