...
import 'package:hellomegha/models/home_video_model.dart';

class HomeVideoViewModel extends ChangeNotifier{
  HomeVideoModel? homeVideoModel;

  Future<void> homeVideoAPI({required BuildContext context}) async {
    var params = {};
    Api.request(
      method: HttpMethod.get,
      path: ApiEndPoints.homeVideo,
      params: params,
      ...
      onResponse: (response) async {
        if (response['status'] != "false"){
          homeVideoModel = HomeVideoModel.fromJson(response['data']);
