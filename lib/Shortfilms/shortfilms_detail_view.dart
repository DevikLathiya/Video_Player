...
class ShortfilmsDetailView extends ConsumerStatefulWidget {
  final String movieId;
  const ShortfilmsDetailView({Key? key, required this.movieId})
      : super(key: key);

  @override
  ConsumerState<ShortfilmsDetailView> createState() =>
      _ShortfilmsDetailViewState();
}

class _ShortfilmsDetailViewState extends ConsumerState<ShortfilmsDetailView> {
  List<String> cast = [
