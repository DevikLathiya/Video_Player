class SuggestMovieModel {
  SuggestMovieModel({
      this.suggestlist,});

  SuggestMovieModel.fromJson(dynamic json) {
...
SuggestMovieModel copyWith({  List<Suggestlist>? suggestlist,
}) => SuggestMovieModel(  suggestlist: suggestlist ?? this.suggestlist,
);
