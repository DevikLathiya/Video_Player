class SuggestLeaderModel {
  SuggestLeaderModel({
      this.suggestlist,});

  SuggestLeaderModel.fromJson(dynamic json) {
  ...
  SuggestLeaderModel copyWith({  List<Suggestlist>? suggestlist,
}) => SuggestLeaderModel(  suggestlist: suggestlist ?? this.suggestlist,
);
