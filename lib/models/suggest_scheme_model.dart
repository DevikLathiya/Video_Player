class SuggestSchemeModel {
  SuggestSchemeModel({
      this.suggestlist,});

  SuggestSchemeModel.fromJson(dynamic json) {
...
SuggestSchemeModel copyWith({  List<Suggestlist>? suggestlist,
}) => SuggestSchemeModel(  suggestlist: suggestlist ?? this.suggestlist,
);
