...
/// The main screen.
class MainScreen extends State<MyApps> {
  ...
  @override
  void didUpdateWidget(covariant MyApps oldWidget) {
                      ...
                      if (mediaItem.artUri != null)
                        Expanded(
                          child: Padding(
                            ...
                            child: Center(
                              child: CommonImage(imageUrl: '${mediaItem.artUri!}'),
                            ),
                          ),
                        ),
...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  Future<void> _init() async {
    ...
    // with updates.
    speed.debounceTime(const Duration(milliseconds: 0)).listen((speed) {
