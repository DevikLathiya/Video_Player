...
class SchemesListView extends ConsumerStatefulWidget {
  const SchemesListView({Key? key, required this.categoryType})
      : super(key: key);
...
class _SchemesListViewState extends ConsumerState<SchemesListView> {
  ...
  void didChangeDependencies() {
    ...
    Connectivity().checkConnectivity().then((value) {
      ...
      {
        ref.watch(schemesListProvider).schemesListAPI(context: context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
          child: ref.watch(schemesListProvider).schemesLists != null &&
                  ref.watch(schemesListProvider).schemesLists!.isNotEmpty
              ? Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(children: [
                        Expanded(
                          child: Text(
                            '${ref.watch(schemesListProvider).schemesLists!.length} Scheme Films',
                            style: TextStyle(
                                fontFamily: Strings.robotoMedium,
