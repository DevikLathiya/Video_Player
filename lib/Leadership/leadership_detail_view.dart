...
class LeadershipDetailView extends StatefulWidget {
  const LeadershipDetailView({Key? key}) : super(key: key);

  @override
  State<LeadershipDetailView> createState() => _LeadershipDetailViewState();
}

class _LeadershipDetailViewState extends State<LeadershipDetailView> {
  List<String> stories = [
