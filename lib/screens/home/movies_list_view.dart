...
class MoviesListView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MoviesListView> createState() => _MoviesListViewState();
}

class _MoviesListViewState extends ConsumerState<MoviesListView> {
  List<String> music = [
  ...
  //   ref.watch(movieListProvider).moviesListAPI(context: context);
  // }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ref.watch(movieListProvider).movieList != null &&
                ref.watch(movieListProvider).movieList!.movielist!.isNotEmpty
            ? Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(children: [
                      Expanded(
                        child: Text(
                          '${ref.watch(movieListProvider).movieList!.movielist!.length} Videos',
                          style: TextStyle(
                              fontFamily: Strings.robotoMedium,
